...
- `gradle/wrapper/gradle-wrapper.jar` is intentionally untracked to satisfy binary-restricted PR tooling in this repository.
...
- Runs: `flutter pub get`, `flutter analyze`, `flutter test`, then `gradle -p android app:assembleDebug --no-daemon`.
